...
const user = JSON.parse(localStorage.getItem('user'));
  ...
  const stats = [
    { title: 'Total Orders', value: '1,248', icon: <ShoppingCart />, change: '+12%', color: 'bg-blue-500' },
    { title: 'Total Amount', value: '548', icon: <IndianRupee />, change: '+8%', color: 'bg-green-500' },
    { title: 'Credit Amount', value: '24.5K', icon: <IndianRupee />, change: '+23%', color: 'bg-purple-500' },
    { title: 'Growth Rate', value: '34%', icon: <TrendingUp />, change: '+5%', color: 'bg-yellow-500' },
    { title: 'Today Orders', value: '1,248', icon: <Calendar />, change: '+12%', color: 'bg-blue-500' },
    { title: 'Today Accepted Orders', value: '548', icon: <CheckCircle />, change: '+8%', color: 'bg-green-500' },
    { title: 'Today Shipped', value: '24.5K', icon: <Truck />, change: '+23%', color: 'bg-purple-500' },
    { title: 'Today Delivered', value: '34%', icon: <PackageCheck />, change: '+5%', color: 'bg-yellow-500' },
  ];
