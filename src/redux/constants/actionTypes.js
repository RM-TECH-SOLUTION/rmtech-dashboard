...
export const UPLOADCMSIMAGE_CMS_REQUEST = 'cms/DELETE_CMS_REQUEST';
export const UPLOADCMSIMAGE_CMS_SUCCESS = 'cms/DELETE_CMS_SUCCESS';
export const UPLOADCMSIMAGE_CMS_FAILURE = 'cms/DELETE_CMS_FAILURE';
export const CREATE_MERCHANT_REQUEST = 'cms/DELETE_CMS_REQUEST';
export const CREATE_MERCHANT_SUCCESS = 'cms/DELETE_CMS_SUCCESS';
export const CREATE_MERCHANT_FAILURE = 'cms/DELETE_CMS_FAILURE';
export const MERCHANT_LOGIN_REQUEST = 'cms/MERCHANT_LOGIN_REQUEST';
export const MERCHANT_LOGIN_SUCCESS = 'cms/MERCHANT_LOGIN_SUCCESS';
export const MERCHANT_LOGIN_FAILURE = 'cms/MERCHANT_LOGIN_FAILURE';
export const GET_MERCHANT_REQUEST = 'cms/GET_MERCHANT_REQUEST';
export const GET_MERCHANT_SUCCESS = 'cms/GET_MERCHANT_SUCCESS';
export const GET_MERCHANT_FAILURE = 'cms/GET_MERCHANT_FAILURE';
export const UPDATE_MERCHANT_REQUEST = 'cms/UPDATE_MERCHANT_REQUEST';
export const UPDATE_MERCHANT_SUCCESS = 'cms/UPDATE_MERCHANT_SUCCESS';
export const UPDATE_MERCHANT_FAILURE = 'cms/UPDATE_MERCHANT_FAILURE';
